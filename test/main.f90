...
contains
    function run() result(passed)
        ...
        individual_tests(1) = fallible_element_fallible_element()
        individual_tests(2) = fallible_member_fallible_member()
        individual_tests(3) = fallible_object_fallible_object()
        individual_tests(4) = fallible_string_fallible_string()
        individual_tests(5) = json_json()
        individual_tests(6) = parse_json_parse_json()
